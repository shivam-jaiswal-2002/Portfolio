...
const CertificateBox = ({ name, image }) => {
  return (
    <div className="bg-gray-400 hover:bg-gray-200 active:bg focus:outline-none focus:ring focus:ring-violet-300 shadow-lg rounded-lg p-4 flex flex-col items-center justify-center">
